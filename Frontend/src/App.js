  ...
  return (
    <section className="bg-gradient-to-t from-emerald-50 to-white">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <p className="text-center mt-8 text-slate-700 max-w-2xl mx-auto">We’re passionate about empowering youth with knowledge and support. Want to help? <a href="mailto:hello@somaai.org" className="text-emerald-600 underline">Get in touch</a>.</p>
      </div>
    </section>
  );
}
