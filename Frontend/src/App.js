		...
		<section className='relative bg-gradient-to-b from-blue-50 via-blue-50 to-emerald-50/30 overflow-hidden flex flex-col items-center justify-center'>
			<div className='max-w-3xl w-full mx-auto flex flex-col items-center justify-center py-24 px-4'>
				...
				<div className='mt-8 flex gap-4 justify-center'>
					<Link
						to='/chat'
						className='px-6 py-3 text-lg rounded-xl bg-emerald-600 text-white shadow-lg font-bold hover:scale-105 transition-all'
						replace>
						Try SomaAI Chat
					</Link>
					<Link
						to='/lessons'
						className='px-6 py-3 text-lg rounded-xl bg-white border border-emerald-400 text-emerald-700 shadow hover:bg-emerald-50 transition-all font-bold'
						replace>
						Browse Lessons
					</Link>
				</div>
				...
				<div className='grid md:grid-cols-3 gap-6 text-center'>
					<div className='rounded-2xl bg-blue-50 shadow p-6 flex flex-col items-center'>
						...
						<p className='text-slate-700'>
							Type your question or browse our lessons. No topic is
							off-limits—SomaAI is here for you.
						</p>
					</div>
					<div className='rounded-2xl bg-emerald-50 shadow p-6 flex flex-col items-center'>
						...
						<p className='text-slate-700'>
							No personal info, no judgment. We keep your questions private and
							never store who you are.
						</p>
					</div>
					<div className='rounded-2xl bg-pink-50 shadow p-6 flex flex-col items-center'>
						...
						<p className='text-slate-700'>
							Get simple, accurate, culturally respectful answers—plus videos
...
function Challenge() {
	...
	return (
		<section
			id='challenge'
			className='bg-gradient-to-b from-emerald-50 via-emerald-50 to-white'>
			<div className='max-w-6xl mx-auto px-4 py-12 md:py-16'>
			...
			<div className='max-w-6xl mx-auto px-4 py-12 md:py-16'>
				...
				<div className='grid md:grid-cols-3 gap-8 text-center'>
					<div className='rounded-2xl shadow bg-white p-8'>
						...
						<p className='text-slate-700'>
							SomaAI learns from the latest trusted resources and is regularly
							updated by health experts.
						</p>
					</div>
					<div className='rounded-2xl shadow bg-white p-8'>
						<span className='text-4xl mb-3 block'>🌐</span>
						...
						<p className='text-slate-700'>
							Use SomaAI in English, French, Portuguese, Swahili, Spanish,
							Hindi, and more. Inclusive for all backgrounds.
						</p>
					</div>
					<div className='rounded-2xl shadow bg-white p-8'>
						<span className='text-4xl mb-3 block'>🧑‍🤝‍🧑</span>
						...
						<p className='text-slate-700'>
							Built with the help of youth and health educators to answer real
							questions, not just textbook ones.
						</p>
					</div>
				</div>
			</div>
		...
		<section id='faq' className='bg-white'>
			<div className='max-w-6xl mx-auto px-4 py-12 md:py-16'>
				...
				<div className='mt-8 rounded-2xl border border-slate-100 divide-y divide-slate-100 bg-white'>
					{items.map((item, i) => (
						<details key={i} className='group p-4 transition-all duration-300'>
							...
							<p className='mt-2 text-sm text-slate-700 transition-all duration-300'>
								{item.a}
							</p>
						</details>
					))}
