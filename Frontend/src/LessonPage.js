    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
                <Navbar />
                <div className="flex items-center justify-center h-[calc(100vh-80px)] pt-20 sm:pt-24 md:pt-28 px-4">
                    <motion.div
                        animate={{ rotate: 360 }}
            ...
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
                ...
                <div className="flex items-center justify-center h-[calc(100vh-80px)] pt-20 sm:pt-24 md:pt-28 px-4">
                    <div className="text-center">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-700 mb-3 sm:mb-4">Lesson Not Found</h1>
                        <p className="text-sm sm:text-base text-slate-500">The lesson you're looking for doesn't exist.</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
            ...
            <motion.section
                ...
                className="relative overflow-hidden py-8 sm:py-12 md:py-16 px-4 sm:px-6 pt-24 sm:pt-28 md:pt-32">
                <div className="max-w-6xl mx-auto">
                    <motion.div
                        ...
                        <motion.h1
                            ...
                            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-4 sm:mb-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent px-2">
                            {data.name}
                        </motion.h1>
                        ...
                        <motion.div
                            ...
                            {['content', 'video', 'related'].map((section) => (
                                <motion.button
                                    ...
                                    className={`px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base font-semibold transition-all duration-300 ${
                ...
                <motion.div
                    ...
                    className="hidden md:block absolute top-20 left-10 w-24 h-24 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full opacity-20 blur-xl"
                />
                <motion.div
                    animate={{
                        y: [0, 20, 0],
                    ...
                    className="hidden md:block absolute top-40 right-20 w-32 h-32 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full opacity-20 blur-xl"
                />
            </motion.section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                            ...
                            <AnimatePresence mode="wait">
                                {activeSection === 'content' && (
                                    <motion.div
                                        ...
                                        className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-6 md:p-8 border border-slate-200">
                                        <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none">
                                            <Markdown
                                                components={{
                                                    p: ({ node, ...props }) => (
                                                        <p className="mb-3 sm:mb-4" {...props} />
                                                    ),
                                                    h1: ({ node, ...props }) => (
                                                        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4" {...props} />
                                                    ),
                                                    h2: ({ node, ...props }) => (
                                                        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3" {...props} />
                                                    ),
                                                    ul: ({ node, ...props }) => (
                                        ...
                                        {hasCompleted && currentIdx !== null && currentIdx + 1 < allLessons.length && (
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.97 }}
                                                className="mt-4 sm:mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl shadow-lg font-bold text-sm sm:text-base md:text-lg hover:shadow-indigo-500/25 transition-all duration-300 w-full sm:w-auto"
                                ...
                                {activeSection === 'video' && data.video && (
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.3 }}
                                        className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-6 md:p-8 border border-slate-200">
                                        <h2 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4 sm:mb-6">Video Lesson</h2>
                                                ...
                                                >
                                                    <div onClick={() => navigate(`/lesson/${lesson.id}`)} className="cursor-pointer">
                                                        <LessonCard
                                                            id={lesson.id}
                                                            name={lesson.name}
                                                            content={lesson.content.slice(0, 100) + "..."}
                                                            index={i}
                                                        />
                                                    </div>
                                                </motion.div>
                        ...
                        <motion.div
                            ...
                            <motion.div
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-5 md:p-6 border border-slate-200">
                                ...
                                <div className="space-y-2 sm:space-y-3">
                                    <motion.button
                                        ...
                                        className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-indigo-500/25 transition-all duration-200 text-sm sm:text-base">
                                    ...
                                    <motion.button
                                        ...
                                        className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-green-500/25 transition-all duration-200 text-sm sm:text-base">
                                        💾 Save Progress
                                    </motion.button>
                                    <motion.button
                                        whileHover={{ scale: 1.02 }}
                                        ...
                                        className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-orange-500/25 transition-all duration-200 text-sm sm:text-base">
                                        ⭐ Rate Lesson
                                    </motion.button>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-5 md:p-6 border border-slate-200">
                                <h3 className="text-lg sm:text-xl font-bold text-slate-800 mb-3 sm:mb-4">Your Progress</h3>
                                <div className="space-y-3 sm:space-y-4">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm sm:text-base text-slate-600">Completion</span>
                                        <span className="font-bold text-indigo-600 text-sm sm:text-base">{userProgress}%</span>
                                    </div>
                            ...
                            <motion.div
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-5 md:p-6 border border-slate-200">
                                <h3 className="text-lg sm:text-xl font-bold text-slate-800 mb-3 sm:mb-4">Lesson Info</h3>
